...
class TaskCard extends StatelessWidget {
  final Task task;
  final bool isYourPost; // Untuk membedakan gaya tampilan jika perlu

  const TaskCard({Key? key, required this.task, this.isYourPost = false})
    : super(key: key);
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            sizedbox1, // Menggunakan sizedbox1
            Text(
            ...
            if (task.assignedToUserId != null)
              Padding(
                ...
                child: Text(
                  'Ditugaskan ke: ${task.assignedToUserId == currentLoggedInUserId ? "Anda" : "Orang lain"}',
