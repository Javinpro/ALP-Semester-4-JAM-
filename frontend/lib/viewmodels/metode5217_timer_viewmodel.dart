// viewmodels/metode5217_timer_viewmodel.dart
import 'dart:async';
...
final metode5217TimerViewModelProvider = StateNotifierProvider.family<
  metode5217TimerViewModel,
  Map<String, dynamic>,
  String
>((ref, methodId) {
  ...
  return metode5217TimerViewModel(
    vibrationService,
    imagePickerService,
...
class metode5217TimerViewModel extends StateNotifier<Map<String, dynamic>> {
